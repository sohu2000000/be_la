...
typedef int (* pPluginFunc)(void * inbuf, uint32_t in_len, void * outbuf, int32_t * out_len_ptr);
...
int be_plugin_callback(enum tag_vendor vendor,enum tag_model model,void*inbuf,uint32_t in_len,void*outbuf,int32_t*out_len);
